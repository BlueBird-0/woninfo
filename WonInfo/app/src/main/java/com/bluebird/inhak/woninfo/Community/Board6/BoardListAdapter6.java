...
public class BoardListAdapter6 extends RecyclerView.Adapter<BoardListAdapter6.BoardListViewHolder> {
    private ArrayList<BoardListItem> items;
    private MainActivity mainActivity;

    // 적절한 생성자를 제공합니다(데이터 집합의 종류에 따라 다름
    public BoardListAdapter6(ArrayList<BoardListItem> items, MainActivity mainActivity)
    {
        this.items = items;
    ...
    @Override
    public BoardListAdapter6.BoardListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        public BoardListViewHolder(View itemView){
            ...
            title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        Class t = Class.forName("com.bluebird.inhak.woninfo.Community.Board6.BoardViewFragment6");
