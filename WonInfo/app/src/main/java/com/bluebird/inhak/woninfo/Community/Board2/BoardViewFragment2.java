...
public class BoardViewFragment2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
                        ...
                        .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                if(task.isSuccessful()) {
                                    ...
                                    commentListAdapter = new CommentListAdapter2(commentItems,(MainActivity)getActivity());
