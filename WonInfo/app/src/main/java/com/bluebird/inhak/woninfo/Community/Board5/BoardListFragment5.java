...
public class BoardListFragment5 extends Fragment{
    ...
    private BoardListAdapter boardListAdapter5;
    ...
    private void setRecyclerView(){
        ...
        boardListAdapter5 = new BoardListAdapter(items,(MainActivity) getActivity());
        recyclerView.setAdapter(boardListAdapter5);
    ...
    private void setData(){
        ...
        for(int i=0; i<titles.length; i++)
        {
            if( titles[i] != null ) {
                ...
                boardListAdapter5.notifyDataSetChanged();
            }
        }
    }
}*/
