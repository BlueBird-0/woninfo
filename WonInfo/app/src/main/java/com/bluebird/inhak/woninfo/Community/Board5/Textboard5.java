...
public class Textboard5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        sendbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Map<String, String> 동아리홍보방 = new HashMap<>();

                Map<String, String> uData = new HashMap<>();
                //uData.put("title", msg);
                //uData.put("content", msg2);
                //uData.put("date", now);
                동아리홍보방.put("title",editdt.getText().toString());
                동아리홍보방.put("content",editdt2.getText().toString());
                동아리홍보방.put("date",date);
                ...
                db.collection("Community").document("게시판").collection(Board5)
                        .add(동아리홍보방)
